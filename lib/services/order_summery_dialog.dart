      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text('Subtotal: GHC ${cartSummary.totalAmount}',
                style: const TextStyle(fontSize: 16)),
            const Text('Delivery Charge: GHC ${CartSummary.deliveryCharge}',
                style: TextStyle(fontSize: 16)),
            const SizedBox(height: 10),
            Text('Total Amount: GHC ${cartSummary.amountToPay}',
            ...
            const Text('Payment Information:',
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            const Text(
                'You can pay using various methods on Paystack: credit/debit cards, mobile money.'),
          ],
        ),
      ),
      actions: [
